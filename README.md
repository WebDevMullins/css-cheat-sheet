...
- You and your group can decide which CSS styles and colors you will use to design the application, but the app needs to be a responsive. Use the following images to gain an understanding of how the app should look at different screen sizes, from a layout perspective:
  ...
  - At size 992px and above, the app should resemble the following image:
    ...
    ![On a desktop, the application displays three CSS code snippets per row.](https://github.com/WebDevMullins/css-cheat-sheet/assets/6474546/ec2c8f4b-da51-45bb-8284-f0ebc604220f)

  - At size 768px and above, the app should resemble the following image:

    ![On a tablet, the application displays two CSS code snippets per row.](https://github.com/WebDevMullins/css-cheat-sheet/assets/6474546/82df1407-4b0d-4a21-b507-c48eb061f14a)

  - On mobile devices, anything under 768px, the app should resemble the following image:

    ![On a mobile device, the application displays one CSS code snippet per row.](https://github.com/WebDevMullins/css-cheat-sheet/assets/6474546/a65913c6-4925-4fda-9ee6-437daac9f45a)
